...
fbins_ag <- function(start_date, until_date, report_level, fb_access_token, account){
  ...
  content_result <- content(GET(
                  ...
                  query = list(
                    ...
                    level= report_level,
                    fields = "campaign_name","campaign_id, objective, adset_id, adset_name, ad_id, ad_name, impressions, cpm, reach, clicks, unique_clicks, ctr, cpc, unique_ctr, cost_per_unique_click, estimated_ad_recallers, estimated_ad_recall_rate, cost_per_estimated_ad_recallers, spend, canvas_avg_view_time, canvas_avg_view_percent",
                    time_increment="1",
                    limit = "10000",
...
fbins_summ <- function(start_date, until_date, report_level, time_increment, fb_access_token, account){
  ...
  content_result <- content(GET(URL,
                query = list(
                  ...
                  time_range = time_range,
                  level = report_level,
                  fields = "campaign_name, campaign_id, buying_type, account_currency, date_start, date_stop, adset_id, adset_name, ad_id, ad_name, impressions, cpm, reach, frequency, clicks, unique_clicks, ctr, spend, estimated_ad_recall_rate, canvas_avg_view_time, canvas_avg_view_percent",
